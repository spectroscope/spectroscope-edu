...
export const anatomy: RevealLesson = {
  ...
  nodes: {
    "z-mac": { id: "z-mac", type: "zone", x: 0, y: 0, w: 1480, h: 860, data: { variant: "mac", label: "your mac" } },
    "z-os": { id: "z-os", type: "zone", x: 60, y: 600, w: 1320, h: 240, data: { variant: "os", label: "operating system" } },
    user: { id: "user", type: "user", x: 60, y: 240, data: { active: false, prompt: "fix the failing auth test" } },
    llm: { id: "llm", type: "llm", x: 940, y: 60, data: llmData },
    agent: { id: "agent", type: "agent", x: 320, y: 60, data: agentData },
    "os-disk": { id: "os-disk", type: "os", x: 120, y: 660, data: os("disk", { disk: "idle", file: "session.jsonl" }) },
